...
import { ArrowLeft, Save, Lock, Unlock, FileText, Clock } from 'lucide-react'
...
export default function EditArticleForm({
  ...
  const [requiredTier, setRequiredTier] = useState(article.required_tier || 'none')
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12 w-full">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-serif font-bold mt-1 text-gray-900">Edit Dossier</h1>
      </div>
      ...
      <form action={formAction} className="bg-white border border-gray-200 p-5 sm:p-8 space-y-6 shadow-sm">
        ...
        {/* Pass computed isPremium boolean if Server Action requires it */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            >
              ...
              <span>
                {isPaywalled
                  ? `Restricted — only ${meta.label} (${meta.price}) subscribers can read full content.`
